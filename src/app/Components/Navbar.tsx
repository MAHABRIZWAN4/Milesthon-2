      ...
      <div className="flex flex-row gap-3 items-center">
        ...
        <div className='relative -ml-5 md:-ml-14 md:h-14'>
          <Image 
            ...
            width={40} 
            height={40} 
            className="w-full h-full object-contain rounded-full lg:h-16" 
          />
        </div>

        {/* Fixed the unescaped apostrophe */}
        <h1 className="text-white text-[16px] font-semibold -ml-2 leading-[1.2] md:text-[16px] lg:text-[18px] lg:mt-3">
          Mahab&apos;s <br /> Portfolio
        </h1>
      </div>
